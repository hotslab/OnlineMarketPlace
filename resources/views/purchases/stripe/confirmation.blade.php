    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="text-center mt-3 md-4">
                <h4>Thank you for shopping at the</h4>
                ...
                @if ($isDeposit)
                    <p>
                        As the payment you made is the first deposit of <strong>{{ $purchase->product->currency_symbol }} {{ $paidAmount }}</strong>,
                        the other remaining half which is <strong>{{ $purchase->product->currency_symbol }} {{ $depositLeftAmount }}</strong> will be
                        charged after 5 minutes, and notification will sent to your email address of <strong>{{ $purchase->email }}</strong>.
                    </p>
                @endif
